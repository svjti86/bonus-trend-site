  ...
  return (
    <section
      ...
      <div className="flex flex-col justify-between gap-8">
        <div>
          <h3 className="text-neutral text-3xl font-bold">Get Subscribe</h3>
          <h4 className="text-accent text-2xl font-bold md:text-3xl">We will be happy to find the best offer for you.p</h4>
          <p className="text-neutral mt-8">
            I consent to receiving email newsletters (offers, news, promotions) and to the
            processing of my email address in accordance with the Privacy Policy. Unsubscribing is
            available in every email. Your data will not be shared with third parties without a
            legal basis.
          </p>
        </div>
